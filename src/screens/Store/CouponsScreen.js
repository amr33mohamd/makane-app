...
export default function CouponScreen({navigation}) {
    ...
    useEffect(()=>{
        AsyncStorage.getItem('token').then((token)=>{
            ...
            axios.post('https://makane.herokuapp.com/api/store-coupons',null, {
    ...
    var buy_coupon = (id)=>{
        AsyncStorage.getItem('token').then((token)=>{
            axios.post('https://makane.herokuapp.com/api/buy_coupon',null, {
                params:{
                    id
                },
                headers: {
    ...
    var check_coupon = (code)=>{
        ...
        AsyncStorage.getItem('token').then((token)=>{
            axios.post('https://makane.herokuapp.com/api/use-coupon',null, {
                params:{
                    id:code
                },
                headers: {
